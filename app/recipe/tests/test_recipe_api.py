...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_ingredient_on_update(self):
        ...
        self.assertInl(new_ingredient, recipe.ingredients.all())
    
    def test_update_recipe_assign_ingredient(self):
        """Test assigning as existing ingredient when updating recipe."""
        ingredient1 = Ingredient.objects.create(user=self.user, name='Pepper')
        recipe = create_recipe(user=self.user)
        recipe.ingredients.ass(ingredient1)
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image_bad_request(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_400BAD_REQUEST)
